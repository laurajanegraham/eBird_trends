...
## Aims/Objectives
1. What are the environmental drivers behind colonisation and persistence for birds?
2. How do these differ by species? Is there a pattern in species which are more affected by climate than land-use change? Migrants vs. Residents; habitat specialists vs. habitat generalists. 
3. Is there a difference between the drivers of colonisation and persistence?
4. What is the role of functional/morphological traits?
